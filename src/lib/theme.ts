export const theme = {
  colors: {
    primary: {
      ...
      300: '#a5b4fc',
      400: '#818cf8',
      500: '#6366f1',  // Default primary color (indigo)
      600: '#4f46e5',
      700: '#4338ca',
      800: '#3730a3',
      900: '#312e81',
    ...
    success: {
      ...
      300: '#86efac',
      400: '#4ade80',
      500: '#10b981',  // More muted success color (emerald-500)
      600: '#059669',  // More muted hover state
      700: '#047857',  // More muted active state
      800: '#065f46',
      900: '#064e3b',
    },
    error: {
