    ...
    async function fetchLeagueSettings() {
      try {
        ...
        const transformedData: FormData = {
          ...
          roster: {
            pg: leagueData.roster_pg !== null ? leagueData.roster_pg : DEFAULT_ROSTER.pg,
            sg: leagueData.roster_sg !== null ? leagueData.roster_sg : DEFAULT_ROSTER.sg,
            sf: leagueData.roster_sf !== null ? leagueData.roster_sf : DEFAULT_ROSTER.sf,
            pf: leagueData.roster_pf !== null ? leagueData.roster_pf : DEFAULT_ROSTER.pf,
            c: leagueData.roster_c !== null ? leagueData.roster_c : DEFAULT_ROSTER.c,
            g: leagueData.roster_g !== null ? leagueData.roster_g : DEFAULT_ROSTER.g,
            f: leagueData.roster_f !== null ? leagueData.roster_f : DEFAULT_ROSTER.f,
            gf: leagueData.roster_gf !== null ? leagueData.roster_gf : DEFAULT_ROSTER.gf,
            fc: leagueData.roster_fc !== null ? leagueData.roster_fc : DEFAULT_ROSTER.fc,
            util: leagueData.roster_util !== null ? leagueData.roster_util : DEFAULT_ROSTER.util,
            bench: leagueData.roster_bench !== null ? leagueData.roster_bench : DEFAULT_ROSTER.bench,
            ir: leagueData.roster_ir !== null ? leagueData.roster_ir : DEFAULT_ROSTER.ir
          },
          dynasty: {
